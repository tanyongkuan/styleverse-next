  ...
  return (
    <footer>
      <div className="bg-neutral-800 text-neutral-50">
        <div className="flex flex-col items-center gap-4 p-4 lg:py-12">
          <IconPlaceholder>
            <Mail className="h-6 w-6" />
          </IconPlaceholder>
          <span className="text-2xl font-bold">Newsletters</span>
          <span className="text-center text-xs">
            Get the latest updates to our latest collections in your inbox.
          </span>
          <div className="flex items-center gap-4 py-1">
            <TextBox
              placeholder="Enter your email"
              icon={<Mail className="text-neutral-900" />}
            />
            <Button
              text="Subscribe"
              rounded
              className="rounded-lg border-none bg-indigo-500 text-white"
            />
          </div>
          <span className="text-center text-xs">
        ...
        <div className="flex flex-col items-center gap-2 bg-black p-6">
          <span className="text-xl font-bold">StyleVerse</span>
